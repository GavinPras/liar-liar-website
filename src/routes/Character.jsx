...
export default function Character() {
  ...
  return (
    <main className="w-full h-auto overflow-hidden bg-[url('./assets/img/Character/contents_staffcast_bg01.jpg')] bg-center bg-cover">
      <span className="flex justify-center mt-14">
        <img src="./assets/img/Character/contents_header_character.png" alt="header" className="w-[60%] max-w-72" />
      </span>
