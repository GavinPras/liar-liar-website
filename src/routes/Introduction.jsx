export default function Introduction() {
  return (
    <>
      <main className="relative w-full h-auto py-10 justify-center bg-[url('src/assets/img/Introduction/contents_introduction_bg01.jpg')] bg-center bg-cover">
        <div className="absolute z-0 inset-0 overflow-hidden">
          <img src="src\assets\img\Introduction\contents_introduction_bg02.png" alt="bg" className="absolute z-0 object-cover min-h-full" />
          <img src="src\assets\img\Introduction\contents_introduction_bg03.png" alt="bg" className="absolute z-10 object-cover min-h-full" />
          <img src="src\assets\img\Introduction\contents_introduction_bg04.png" alt="bg" className="absolute z-20 object-cover min-h-full" />
        </div>
        ...
        <div className="mt-16 z-40 relative">
          ...
          <div className="flex justify-center items-center flex-col my-16 lg:my-20">
            <img src="src\assets\img\Introduction\contents_introduction_text2.png" alt="content" className="w-auto h-64 md:h-72 lg:h-96 mx-auto" />
          </div>
        </div>
      </main>
    </>
