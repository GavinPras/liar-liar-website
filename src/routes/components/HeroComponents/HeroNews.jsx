export default function HeroNews() {
  ...
  return (
    <>
      <section className="w-full bg-[url('./assets/img/Hero/contents_top_bg01.jpg')] bg-cover bg-bottom h-auto flex justify-center mt-24 pb-36">
        <div className="container w-[90%] lg:max-w-[70rem]">
          <span>
            <img src="./assets\img\Hero\contents_header_news.png" alt="header-news" className="w-[30%] mx-auto md:max-w-36" />
          </span>
          <div className="mt-14">
            <ul>
          ...
          <div className="w-full flex justify-center">
            <button className="cursor-pointer hover:opacity-50 duration-300 mt-12">
              <img className="max-w-[185px]" src="./assets\img\Hero\contents_news_more_button.svg" alt="more-news" />
            </button>
          </div>
        </div>
      </section>
